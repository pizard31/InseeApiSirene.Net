...
namespace InseeApiSirene
{
    ...
    public static class Logger
    {
        ...
        {
            get => _instance;
            set => _instance = value ?? new DefaultLogger();
        }
        ...
        public static void Debug(string message, Exception exception = null) => _instance.Debug(message, exception);
        ...
        /// <param name="exception">L'exception associée au message de journalisation, le cas échéant.</param>
        public static void Info(string message, Exception exception = null) => _instance.Info(message, exception);
        ...
        /// <param name="exception">L'exception associée au message de journalisation, le cas échéant.</param>
        public static void Warning(string message, Exception exception = null) => _instance.Warning(message, exception);
        ...
        public static Boolean IsDebugEnabled() => _instance.IsDebugEnabled();
        ...
        public static Boolean IsInfoEnabled() => _instance.IsInfoEnabled();
        ...
        public static Boolean IsWarningEnabled() => _instance.IsWarningEnabled();
        ...
        public static Boolean IsErrorEnabled() => _instance.IsErrorEnabled();
        ...
        public static Boolean IsFatalEnabled() => _instance.IsFatalEnabled();

        /// <summary>
        /// Classe de log par défaut utilisant System.Diagnostics
        /// </summary>
        /// <remarks>Debug et Info sortent sur Debug, tandis que Warning, Error et Fatal sortent sur Trace.</remarks>
        public class DefaultLogger : ILogger
        {
            ...
            /// <param name="message">Le message à journaliser. Il doit fournir un contexte ou des détails pertinents pour le débogage de l'exécution de l'application.</param>
            /// <param name="exception">L'exception associée au message de journalisation, le cas échéant.</param>
            public void Debug(String message, Exception exception = null) => System.Diagnostics.Debug.WriteLine($"🔍Debug: {message}\n{exception}");
            ...
            /// <param name="message">Le message à journaliser. Il doit fournir un contexte ou des détails pertinents sur l'opération en cours.</param>
            /// <param name="exception">L'exception associée au message de journalisation, le cas échéant.</param>
            public void Info(String message, Exception exception = null) => System.Diagnostics.Debug.WriteLine($"ℹInfos: {message}\n{exception}");
            ...
            /// <param name="message">Le message à journaliser. Il doit fournir un contexte ou des détails pertinents sur l'avertissement émis.</param>
            /// <param name="exception">L'exception associée au message de journalisation, le cas échéant.</param>
            public void Warning(String message, Exception exception = null) => System.Diagnostics.Trace.WriteLine($"⚠Warn : {message}\n{exception}");
            ...
            /// <param name="message">Le message d'erreur à journaliser. Ce message doit fournir un contexte suffisant pour comprendre la nature de l'erreur.</param>
            /// <param name="exception">L'exception associée au message de journalisation, le cas échéant.</param>
            public void Error(String message, Exception exception = null) => System.Diagnostics.Trace.WriteLine($"🚨Error: {message}\n{exception}");
            ...
            /// <param name="message">Un message descriptif qui fournit un contexte pour l'erreur.</param>
            /// <param name="exception">L'exception à journaliser. Ne peut pas être null.</param>
            public void Fatal(String message, Exception exception = null) => System.Diagnostics.Trace.WriteLine($"💀Fatal: {message}\n{exception}");
